# Caribbean source survey (2026-09-26)
...
| Key | Source | How it is read | Coverage seen 2026-09-26 |
|---|---|---|---|
...
2026-09-26 for every new market that lists one (Bermuda and Turks & Caicos
...
* 33 markets at 1.5 s per request is roughly an hour end to end. Eventbrite
  rate-limited a burst probe (HTTP 429) on 2026-09-26; the pipeline's
